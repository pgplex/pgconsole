      ...
      >
        {toasts.map((toast) => {
          ...
          return (
            ...
            >
              <Toast.Close
                className="absolute top-2 right-2 rounded p-0.5 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
                data-slot="toast-close"
              >
                <XIcon className="h-3.5 w-3.5" />
              </Toast.Close>
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden pl-3.5 pr-8 py-3 text-sm transition-opacity duration-250 data-behind:pointer-events-none data-behind:opacity-0 data-expanded:opacity-100">
              ...
              >
                {tooltipStyle ? (
                  ...
                  <>
                    ...
                    <Toast.Content className="pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden pl-3.5 pr-8 py-3 text-sm">
                      <div className="flex gap-2">
                        {Icon && (
                          <div
                            className="[&>svg]:h-lh [&>svg]:w-4 [&_svg]:pointer-events-none [&_svg]:shrink-0"
